...
#===============================================================================
#            File:  start_job.sh [sug_click]
#           Usage:  
#     Description:  sug_click表启动程序
#    LastModified:
#         Created:  2014-6-21 23:02 PM
...
set -x
if [ $# -ne 8 ]; then
	echo "[$0] [ERROR] [`date "+%Y-%m-%d %H:%M:%S"`] [sug_click] input error ! \$#=$# not 8"
	exit -1
fi
