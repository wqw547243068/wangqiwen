...
#===============================================================================
#            File:  start_job.sh [stat_monitor]
#           Usage:  
#     Description:  stat_monitor表启动程序
#    LastModified:
#         Created:  2014-7-1 18:00 PM
#          AUTHOR:  wangyongliang(i-wangyongliang@autonavi.com)
#===============================================================================
...
sql="$path/create_stat.sql" # 2014-6-26
#sql="$path/create_stat.sql"
